...
module.exports = configure(function (ctx) {
  ...
  return {
    ...
    build: {
      ...
      extendWebpack (cfg) {
        // ESLint configuration is now handled via separate commands
    ...
    pwa: {
      ...
      extendManifestJson (json) {
        json.name = 'LUMI SUITE'
        json.short_name = 'LUMI SUITE'
        json.description = 'Bot Multi-atendimento para whatsapp'
    ...
    electron: {
      ...
      extendElectronPreloadConf (esbuildConf) {
        // do something with Electron preload process Webpack cfg
        // chainWebpack also available besides this extendWebpack
      }
    }
  }
